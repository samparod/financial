...
export const sheetHelp: HelpBundle = {
  ar: {
    ...
    "dz.page": {
      ...
      meaning:
        "محاكاة الجزائر مو نفس الخليج: توصيل ناجح ومرتجع بالدينار، ورسوم المنصة من Cost of Service (إعدادات الجزائر بالدولار). ما كاينش شحن ثابت $8 لكل مؤكّد. التكلفة والبيع بالدينار؛ CPL بالدولار.",
      example:
