...
export const sheetHelp: HelpBundle = {
  ar: {
    ...
    "sheet.unitPrice": {
      title: "سعر البيع للواصلة",
      meaning:
        "السعر اللي بعت فيه كل طرد وصل (COD). المبيعات الإجمالية تتحسب وحدها: السعر × عدد Delivered.",
      example: "1) بعت بـ 4 900 د.ج للواصلة و 70 واصلة → المبيعات = 343 000 د.ج. 2) تبدّل الواصلات، المبيعات تتبدّل تلقائياً.",
    },
    "sheet.sales": {
      title: "المبيعات — محسوبة",
      meaning:
        "Total Sales = سعر البيع × Delivered. ما تكتبهاش بيدك — تظهر تحت Gross Revenue كتحصيل COD.",
      example: "سعر 61.25$ × 160 واصلة = 9 800$ مبيعات (أو بالدينار في تبويب الجزائر).",
    },
    "sheet.codCollected": {
